...
| Elastic Certified Analyst / SIEM Analyst | Elastic / SIEM | **400 $** | ⭐⭐⭐⭐ |
| Elastic Certified Engineer / Observability Engineer | Elastic | **500 $** | ⚠️ frontière |

---

# 1. Datadog

Datadog propose actuellement trois examens :
...
Source : https://learn.datadoghq.com/pages/certification

**Valeur : ⭐⭐⭐⭐** pour SRE, observabilité, cloud et exploitation.

---

# 2. Confluent / Apache Kafka
...
**Prix : 150 $ par certification.**

Source : https://training.confluent.io/learn/public/catalog/view/108

À ce prix, c'est une certification très intéressante pour les profils :
...
- 65 questions ;
- score requis : 65 % ;
- recommande environ six mois d'expérience dbt / dbt Core.

Source : https://www.getdbt.com/certifications/analytics-engineer-certification-exam

## dbt Cloud Administrator

Les guides actuels affichent également un tarif de **200 $** pour l'examen Cloud Administrator.

**Valeur : ⭐⭐⭐⭐** pour Modern Data Stack / analytics engineering.
...
|---|---:|
| Associate | **150 $ + taxes** |
| Professional | **300 $ + taxes** |

Exemples :

- Agentic Automation Associate ;
- Software Testing Engineer Professional ;
- Agentic Automation Professional ;
- Automation Developer Professional ;
- Automation Business Analyst Professional.

Source : https://www.uipath.com/learning/certification/faqs

La certification UiPath est particulièrement intéressante pour :
...
Grille Pearson VUE officielle pour les pays développés — dont la France :
...
Source : https://www.pearsonvue.com/us/en/hpe.html

Les intitulés de certifications HPE dépendent du parcours : compute, storage, networking, hybrid cloud, Alletra, GreenLake, etc.

Il faut donc additionner les examens si un credential exige plusieurs tests.

**Valeur : ⭐⭐⭐⭐** dans un environnement HPE.

---

# 6. IBM

IBM localise les tarifs selon pays, mais plusieurs certifications professionnelles actuelles sont affichées à **200 $ aux États-Unis**.

Exemples vérifiés :

- IBM Certified Administrator — Security QRadar SIEM V7.5 ;
- IBM Certified z/OS v3.x Administrator — Professional ;
- IBM Certified Cognos Analytics v12 Analyst / Administrator ;
- IBM Certified Db2 13 for z/OS DBA ;
- IBM Certified watsonx AI Assistant Engineer ;
- IBM Certified watsonx Data Lakehouse Engineer ;
- IBM API Connect Solution Implementer ;
- IBM Sterling File Gateway Administrator.

Source : https://www.ibm.com/training/credentials

**Valeur : ⭐⭐⭐⭐**, très dépendante du produit IBM réellement utilisé.

---

# 7. ServiceNow

Depuis fin 2025, ServiceNow a modifié son système de vouchers et son prestataire d'examen.

Tarifs 2026 communiqués dans la documentation / communauté ServiceNow :

| Certification | Prix |
|---|---:|
| CSA / CAD / CPOA / certifications mainline équivalentes | **300 $ + taxes** |
| CIS | **450 $ + taxes** |

Les cours on-demand peuvent être gratuits, tandis que les formations instructor-led sont beaucoup plus coûteuses.

Les anciennes histoires de « voucher gratuit après le cours » ne doivent donc pas être reprises automatiquement.

Source de référence : ServiceNow University / documentation de transition Pearson VUE.

**Valeur : ⭐⭐⭐⭐⭐** dans un environnement ServiceNow.
...
Source : https://www.elastic.co/training/certification/faq

Les examens Engineer sont performance-based.

> Les examens à exactement 500 $ sont à la **frontière** de notre catégorie : TVA et conversion peuvent faire dépasser 500 €.

**Valeur : ⭐⭐⭐⭐–⭐⭐⭐⭐⭐** selon usage Elastic / Elasticsearch / SIEM.

---

# 9. Microsoft Office Specialist — MOS
...
Certiport US affiche à titre de référence :

- voucher MOS : **104 $** ;
- voucher + retake : **120 $**.

Source Microsoft : https://learn.microsoft.com/credentials/certifications/browse/?credential_types=certification&products=office

**Valeur : ⭐⭐⭐⭐** pour fonctions support, management, finance et métiers où Excel/Office sont centraux.

---

# 10. Adobe Certified Professional

Le prix dépend du pays et du centre Certiport.

Référence officielle US online : **150 $ par examen**.

Certifications disponibles notamment sur :
...
- After Effects ;
- Acrobat ;
- autres outils Adobe selon catalogue.
...
| Niveau | Prix |
|---|---:|
| Autodesk Certified Associate | **150 $** |
| Autodesk Certified Professional | **200 $** |
| Autodesk Certified Expert | **250 $** |

Source : https://www.autodesk.com/certification/overview

Applicable selon métier à AutoCAD, Fusion, Revit, Inventor et autres produits Autodesk.

**Valeur : ⭐⭐⭐⭐** pour ingénierie / CAO / BIM.

---

# 12. Certiport — autres credentials accessibles

Le store américain Certiport donne une bonne idée des ordres de grandeur :

| Credential | Prix US indicatif |
|---|---:|
| IC3 Digital Literacy | **37 $** |
| Critical Career Skills | **72 $** |
| Microsoft Certified Educator | **78 $** |
| Entrepreneurship and Small Business | **84 $** |
| Autodesk Certified User | **94 $** |
| Microsoft Office Specialist | **104 $** |
| PMI Project Management Ready | **123 $** |
| Unity Certified User + retake | **130 $** |
