...
- packaging / labeling ;
- systèmes qualité ;
- réglementation et contrôle des procédés.

Source :

- https://www.asq.org/cert/pharmaceutical-gmp

### Recertification

CPGP fait partie des certifications ASQ à recertifier tous les **3 ans** :

- 18 Recertification Units ; ou
- repassage de l'examen.

Recertification par journal :

- **120 $ membre** ;
- **160 $ non-membre** pour une certification.
...
# 2. Autres certifications ASQ pertinentes pharma / quality
...
# 3. RAPS — Regulatory Affairs Certification
...
Les examens RAC sont des credentials professionnels établis pour les affaires réglementaires pharmaceutiques / dispositifs médicaux.

Source :

- https://live.raps.org/education/

---

# 4. RAPS — Regulatory Compliance Certificates
...
Ces credentials sont nettement moins chers que RAC et ciblent le cadre réglementaire européen :
...
# 5. RAPS — Fundamentals / FRA

Les assessment-based certificates d'introduction sont encore plus accessibles.

## FRA: Introduction to Regulatory Affairs — Pharmaceuticals

- **200 $ membre** ;
- **300 $ non-membre**.

## FRA: Introduction to Regulatory Affairs — Medical Devices
...
- https://live.raps.org/search

---

# 6. ACRP — Clinical Research

ACRP propose notamment :
...
Membership individuel industrialized-country : autour de **160 $/an** ; membership **non obligatoire** pour obtenir la certification.
...
- early : **225 $ membre / 300 $ non-membre** ;
- regular : **250 $ membre / 325 $ non-membre**.

Le maintien requiert également des points / continuing education selon credential.
...
# 7. SOCRA — Certified Clinical Research Professional
...
**390 $** dans l'année suivant l'examen initial.
...
- expérience admissible selon catégorie.
...
- **350 $** pour trois ans ;
- ou installment plan **200 + 100 + 100 $** ;
- **45 heures** de continuing education ;
- module réglementaire SOCRA.

Source :

- https://www.socra.org/certification/recertification/ccrp-renewal-of-certification/
...
**RAPS RAC Drugs / Devices**.

## Réglementation européenne dispositif médical

**RCC MDR / IVDR**.

## Début en affaires réglementaires

**RAPS FRA**.

## Clinical Research Associate / Coordinator / PI

**ACRP** selon fonction.

## Credential clinique transversal
