---
title: "Construction / BTP — catalogue mondial des credentials 2026"
...
# Construction / BTP — catalogue mondial des credentials 2026

> Recensement large des certifications, qualifications professionnelles, accréditations, habilitations et credentials utiles au **BTP / construction / génie civil / built environment**.
>
> **Snapshot : 28 août 2026.** Ce fichier complète les fiches spécialisées du dépôt ; il sert de radar mondial et de table de correspondance, pas de substitut aux pages officielles.

---

# 0. Légende : ne pas tout appeler « certification »

| Code | Nature | Exemple |
|---|---|---|
| **CERT** | certification de personne avec examen/assessment | AACE PSP, BCSP CHST, AWS CWI |
| **QUAL** | qualification / statut professionnel avec expérience, dossier ou interview | MRICS, MCIOB, CEng |
| **ACC** | accréditation professionnelle liée à un scheme | BREEAM Assessor, Fitwel Ambassador |
| **REG** | exigence réglementaire, habilitation, carte ou attestation | AIPR, CACES, SSIAP |
| **COURSE** | credential / certificat de parcours ou produit | Procore Certification |
| **ORG** | qualification/certification d'entreprise, pas de personne | QUALIBAT, ISO 9001 entreprise |

Le dépôt conserve la logique TCO :
...
# 1. Construction management, cost engineering, planning & estimating
...
Source : https://www.pmi.org/certifications/construction

---

## AACE International — 9 certifications actives dans le portefeuille 2026
...
- https://web.aacei.org/certification
- https://web.aacei.org/certification/certification-information
- https://web.aacei.org/certification/certification-information/certifications-offered/professional-certifications
...
Source : https://dbia.org/certification/
...
Source : https://ccifp.org/

---

# 2. Quantity surveying, surveying & professional chartered routes

Ces titres sont souvent des **qualifications professionnelles** : diplôme/expérience + dossier + interview + membership/CPD. Ils ne sont pas comparables à un voucher d'examen.
...
- Infrastructure
- Geomatics
- Commercial Property / Facilities selon rôle

Sources :

- https://www.rics.org/join-rics
- https://www.rics.org/join-rics/rics-member-grades
- https://www.rics.org/surveyor-careers/career-development/surveying
...
# 3. Contracts, claims, procurement & infrastructure delivery
...
Registre d'accréditations professionnelles NEC observé en 2026 :
...
Source : https://ppp-certification.com/

---

# 4. BIM, openBIM, CAO & construction numérique
...
## Autodesk Certification — AEC

Familles Autodesk pertinentes au BTP selon catalogue d'examens disponible :
...
Source : https://www.autodesk.com/certification

---

## Procore Certification

Credentials gratuits, rôle/produit, classés **COURSE** : ils prouvent la maîtrise du workflow Procore mais ne sont pas des certifications indépendantes de personne au sens ISO 17024.
...
Source : https://learn.procore.com/certification

---

# 5. Green building, sustainable construction & healthy buildings
...
- https://breeam.com/training
- https://tools.breeam.com/projects/explore/companies.jsp
- https://breeam.com/breeam-infrastructure/about/how-it-works/assessors-and-verifiers
...
Source : https://www.sustainablesites.org/professionals
...
Source : https://true.gbci.org/true-advisor
...
Source : https://www.nabers.gov.au/accredited-assessors
...
# 6. Residential building performance / energy ratings
...
Source : https://www.bpi.org/resources/

---

# 7. HVAC, energy, commissioning & building services
...
Attention : plusieurs certifications AEE exigent un **approved training program**. Le TCO ne se réduit pas au fee d'application/examen.

Source : https://www.aeecenter.org/certifications/
...
# 8. Facility management & property operations
...
# 10. Building enclosure / roofing consulting
...
Certifications hands-on de National Roofing Contractors Association :

- Architectural Metal Flashings and Accessories Installer
- Asphalt Shingle Systems Installer
- Clay and Concrete Tile Systems Installer
- EPDM Systems Installer
- Metal Panel Roof Systems Installer
- Metal Shingle Systems Installer
- Modified Bitumen Systems Installer
- Service and Maintenance Technician
- Slate Systems Installer
- Thermoplastic Systems Installer
- Roofing Foreman

Type : **CERT**.

Source : https://www.nrca.net/procertification

---

# 11. Concrete — ACI Certification

ACI maintient plus de 30 programmes. La liste ci-dessous est volontairement détaillée car ces credentials sont très utilisés en QA/QC, inspection et exécution béton.

## Aggregate

- Aggregate Testing Technician — Level 1
- Aggregate Testing Technician — Level 2
- Aggregate Base Testing Technician — AASHTO
- Aggregate Base Testing Technician — ASTM
...
- Nondestructive Testing Specialist — Concrete Strength
- GFRP Reinforcing Bar Inspector
- Shotcrete Inspector

## Installation / finishing / specialty
...
- Decorative Concrete Flatwork Associate
- Concrete Quality Technical Manager
- Shotcreter — Dry-Mix Process
...
- ACI 318 Design Professional — versions d'examen selon code actif, dont ACI 318-19 dans le catalogue observé

Type général : **CERT**.

Source : https://www.concrete.org/certification/certificationprograms.aspx
...
# 13. Post-tensioning — PTI

Familles de certifications / levels observées :

## Unbonded PT

- Level 1 Unbonded PT Installation
- Level 2 Unbonded PT Installer
- Level 2 Unbonded PT Inspector
- Level 2 Unbonded PT Ironworker
- Level 1 Unbonded PT Repair
- Level 2 Unbonded PT Repair Specialist
...
## Multistrand / grouted PT

- Level 1 Multistrand and Grouted PT Installation
- Level 1 Multistrand and Grouted PT Inspection
- Level 2 Multistrand and Grouted PT Specialist
- Level 2 Multistrand and Grouted PT Inspector

Source : https://www.post-tensioning.org/certification/
...
- API 1104 Pipeline
- ASME BPVC / B31
- ISO-related endorsements selon session

Source : https://www.aws.org/certification/
...
VT  Visual Testing
+ autres méthodes selon scheme ASNT
```

Source : https://www.asnt.org/certification

---

# 16. Corrosion, coatings & cathodic protection — AMPP
...
- C6 Power Tool Cleaning / brush-and-roll
- C7 Abrasive Blaster
- C12 Spray Application
- C13 Waterjetting
- C14 Marine Plural Component
- Plural Component Application Level 2
- Thermal Applicator Level 2
- Aerospace Coating Application Specialist

Legacy : **CCA** a été fusionné vers CAS Level 2 et n'est plus attribué comme nouveau credential.

Source : https://www.ampp.org/education/certification

---

# 17. Building codes & special inspection — ICC

ICC propose un très grand catalogue. Pour le BTP, les familles les plus directement pertinentes sont :
...
ICC propose également des credentials / combination designations de type :

- Code Enforcement Technician
- Code Enforcement Officer
- Building Official
- Code Specialist
- Fire Marshal / fire-code pathways selon examens composant le designation

Source : https://www.iccsafe.org/professional-development/certifications-and-testing/

---

# 18. Construction materials & transportation inspection — NICET
...
Source : https://www.nicet.org/certification-programs/

---

# 19. Cranes, lifting, rigging & load handling — CCO / NCCCO

Programmes de certification identifiés dans les handbooks CCO :
...
## Rigging / signaling / inspection

- **Rigger Level I**
- **Rigger Level II**
- **Signalperson**
- **Crane Inspector** — specialties mobile / tower / overhead selon programme
- **Lift Director** — mobile / tower specialties

Type : **CERT**, plusieurs programmes accrédités ISO/IEC 17024.

Source : https://www.nccco.org/certification

---

# 20. Occupational safety — construction

## BCSP

Déjà documenté : [`safety-professional-bcsp.md`](safety-professional-bcsp.md).
...
Source : https://www.nebosh.org.uk/qualifications/
...
# 21. France — réglementaire, habilitations & qualifications individuelles

Cette section ne doit surtout pas être mélangée avec les certifications internationales : le droit d'exercer ou la validité dépend du texte, du rôle employeur, de l'organisme et du recyclage.
...
Source : https://www.reseaux-et-canalisations.ineris.fr/

---

## CACES — recommandations CNAM / INRS

Le **CACES n'est pas l'autorisation de conduite** : c'est un certificat d'aptitude pouvant servir à l'employeur pour délivrer son autorisation.
...
Source : https://www.inrs.fr/publications/bdd/caces.html
...
## SSIAP — sécurité incendie ERP / IGH
...
Source : https://travail-emploi.gouv.fr/batiment-et-genie-civil-coordination-en-matiere-de-securite-et-de-protection-de-la-sante-csps

---

## Habilitation électrique — NF C 18-510

Exemples de symboles courants, à ne pas interpréter sans le domaine exact :
...
Type : **REG / habilitation employeur**. La formation seule n'est pas l'habilitation.

Source : https://www.inrs.fr/risques/electriques/habilitation-electrique.html
...
## Diagnostics immobiliers — certifications de personne
...
Rôles de formation réglementaire selon situation :

- opérateur de chantier
- encadrant de chantier
- encadrant technique
- cumul de fonctions selon dispositifs applicables

Type : **REG / attestation de compétence issue d'une formation réglementée**, à distinguer d'une certification professionnelle internationale.

Source : https://travail-emploi.gouv.fr/amiante

---

# 22. Certifications d'organisation / qualifications d'entreprise à ne pas mélanger avec les personnes

Ces dispositifs sont très importants dans le BTP français mais doivent être indexés comme **ORG** :

```text
QUALIBAT
RGE / Reconnu Garant de l'Environnement selon qualification portée par l'entreprise
QUALIFELEC
OPQIBI
MASE
...
certifications de produits / ouvrages / bâtiments
```

À l'inverse, un **Lead Auditor ISO 45001**, un **diagnostiqueur certifié**, un **CWI** ou un **CHST** sont des credentials de personne.

---

# 23. Taille du radar 2026

En comptant les spécialités explicitement nommées dans ce fichier, le domaine construction dépasse déjà largement **150 credentials / qualifications / accréditations / catégories réglementaires** avant même de compter :

- toutes les certifications fire protection NICET ;
- toutes les licences professionnelles d'architecte/PE/ingénieur par État ou pays ;
- toutes les cartes chantier nationales ;
- toutes les qualifications artisanales ;
- toutes les certifications fabricants ;
- les milliers de certifications produits et bâtiments.

L'objectif de `human-skills` reste de recenser ce qui produit une **preuve professionnelle portable et identifiable**, avec un TCO et un statut clair.

---

# 24. Watchlist à vérifier / consolider dans les prochaines revues

Les familles suivantes ont été identifiées comme pertinentes mais ne sont pas encore intégrées comme entrées vérifiées dans le corps du catalogue :
...
Fire / life safety
  ...
  NFPA individual certifications

Survey / geospatial
  ASPRS certifications
  NSPS surveyor credentials
  drone / UAS mapping credentials selon juridiction

High-performance residential
  PHIUS/RESNET extensions
  ENERGY STAR verifier/rater roles
  HERSH2O specializations

France
  travail en hauteur
  échafaudage R408/R457 selon rôle
  montage/démontage/utilisation
  autorisations et formations plomb
  interventions en espaces confinés / CATEC selon activités
  habilitations gaz / distribution selon exploitant

Rail / road / infrastructure
  ATSSA roadway safety credentials
  rail competence schemes par pays

Digital construction
  Bentley accreditation / certifications
  Graphisoft / Archicad credentials
  Bluebeam certifications
  Trimble / Tekla credentials
  Solibri credentials
```

Une entrée de watchlist n'est pas considérée comme « active vérifiée » tant que la source officielle, le statut du credential et le modèle TCO n'ont pas été confirmés.

---

# 25. Sources officielles principales

```text
PMI            https://www.pmi.org/certifications/construction
AACE           https://web.aacei.org/certification
CMAA           https://www.cmaanet.org/certification
DBIA           https://dbia.org/certification/
CSI            https://www.csiresources.org/certification
RICS           https://www.rics.org/join-rics
CIOB           https://www.ciob.org/membership
ICE            https://www.ice.org.uk/membership
IStructE       https://www.istructe.org/
CIBSE          https://www.cibse.org/registration
CICES          https://www.cices.org/membership/
FIDIC FCL      https://fcl.fidic.org/
NEC            https://www.neccontract.com/get-accredited
buildingSMART  https://education.buildingsmart.org/
Autodesk       https://www.autodesk.com/certification
Procore        https://learn.procore.com/certification
USGBC          https://www.usgbc.org/credentials
WELL           https://www.wellcertified.com/well-ap/
BREEAM         https://breeam.com/training
Phius          https://www.phius.org/certifications/professionals
SITES          https://www.sustainablesites.org/professionals
TRUE           https://true.gbci.org/true-advisor
ASHRAE         https://www.ashrae.org/professional-development/ashrae-certification
AEE            https://www.aeecenter.org/certifications/
NEBB           https://www.nebb.org/certified-professionals/
IFMA           https://www.ifma.org/credentials/
IIBEC          https://iibec.org/credentials/
ACI            https://www.concrete.org/certification/certificationprograms.aspx
ICRI           https://www.icri.org/certification/
PTI            https://www.post-tensioning.org/certification/
AWS            https://www.aws.org/certification/
ASNT           https://www.asnt.org/certification
AMPP           https://www.ampp.org/education/certification
ICC            https://www.iccsafe.org/professional-development/certifications-and-testing/
NICET          https://www.nicet.org/certification-programs/
CCO            https://www.nccco.org/certification
BCSP           https://www.bcsp.org/credentials-at-a-glance
NEBOSH         https://www.nebosh.org.uk/qualifications/
INRS/CACES     https://www.inrs.fr/publications/bdd/caces.html
```

---

# 26. Fiches `human-skills` complémentaires

- [`construction-cost-engineering.md`](construction-cost-engineering.md)
- [`green-building-sustainability.md`](green-building-sustainability.md)
- [`facilities-energy-qhse.md`](facilities-energy-qhse.md)
- [`occupational-safety-nebosh-iosh.md`](occupational-safety-nebosh-iosh.md)
- [`safety-professional-bcsp.md`](safety-professional-bcsp.md)
- [`public-procurement-ppp.md`](public-procurement-ppp.md)
- [`tools-platforms-under-500.md`](tools-platforms-under-500.md)

Ce fichier est le **radar global construction** ; les fiches spécialisées restent préférables pour les prix, prérequis, maintenance et first-cycle TCO détaillés.
